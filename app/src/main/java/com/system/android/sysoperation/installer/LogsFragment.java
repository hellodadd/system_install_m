...
public class LogsFragment extends Fragment {
    ...
    private File mFileErrorLog = new File(SysOperationApp.BASE_DIR + "log/error.log");
    private File mFileErrorLogOld = new File(
            SysOperationApp.BASE_DIR + "log/error.log.old");
...
*/
    ...
    private void send() {
        Uri uri = FileProvider.getUriForFile(getActivity(), "com.system.android.sysoperation.installer.fileprovider", mFileErrorLog);
    ...
    private File save() {
        ...
        String filename = String.format(
                "sysoperation_%s_%04d%02d%02d_%02d%02d%02d.log", "error",
