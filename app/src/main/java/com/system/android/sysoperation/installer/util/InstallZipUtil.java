...
import com.system.android.sysoperation.installer.BuildConfig;
import com.system.android.sysoperation.installer.R;
import com.system.android.sysoperation.installer.SysOperationApp;
import com.system.android.sysoperation.installer.installation.FlashCallback;
...
public final class InstallZipUtil {
    ...
    public static class ZipCheckResult {
        ...
        private SysOperationProp mSysOperationProp = null;
        ...
        public boolean hasSysOperationProp() {
            return mSysOperationProp != null;
        }

        public SysOperationProp getSysOperationProp() {
            return mSysOperationProp;
        }
    ...
    public static ZipCheckResult checkZip(ZipFile zip) {
        ...
        ZipEntry sysoperationPropEntry = zip.getEntry("system/sysoperation.prop");
        if (sysoperationPropEntry != null) {
            try {
                result.mSysOperationProp = parseSysOperationProp(zip.getInputStream(sysoperationPropEntry));
            } catch (IOException e) {
                Log.e(SysOperationApp.TAG, "Failed to read system/sysoperation.prop from " + zip.getName(), e);
            }
        }
    ...
    public static class SysOperationProp {
    ...
    public static SysOperationProp parseSysOperationProp(InputStream is) throws IOException {
        SysOperationProp prop = new SysOperationProp();
    ...
    public static String messageForError(int code, Object... args) {
        Context context = SysOperationApp.getInstance();
        switch (code) {
    ...
    public static void reportMissingFeatures(Set<String> missingFeatures) {
        Log.e(SysOperationApp.TAG, "Installer version: " + BuildConfig.VERSION_NAME);
        Log.e(SysOperationApp.TAG, "Missing installer features: " + missingFeatures);
    }
