...
public class SettingsActivity extends SysOperationBaseActivity implements FolderChooserDialog.FolderCallback {
    ...
    public void onFolderSelection(@NonNull FolderChooserDialog dialog, @NonNull File folder) {
        if (folder.canWrite()) {
            SysOperationApp.getPreferences().edit().putString("download_location", folder.getPath()).apply();
        } else {
    ...
    public static class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceClickListener {
        private static final File mDisableResourcesFlag = new File(SysOperationApp.BASE_DIR + "conf/disable_resources");
        ...
        public boolean onPreferenceClick(Preference preference) {
            if (preference.getKey().equals(downloadLocation.getKey())) {
                ...
                new FolderChooserDialog.Builder((SettingsActivity) getActivity())
                        ...
                        .initialPath(SysOperationApp.getDownloadPath())
                        .show();
            }
