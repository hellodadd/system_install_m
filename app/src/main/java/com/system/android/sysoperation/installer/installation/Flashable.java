...
import static com.system.android.sysoperation.installer.util.InstallZipUtil.reportMissingFeatures;
...
public abstract class Flashable implements Parcelable {
    ...
    protected ZipCheckResult openAndCheckZip(FlashCallback callback) {
        ...
        if (zipCheck.hasSysOperationProp()) {
            Set<String> missingFeatures = zipCheck.getSysOperationProp().getMissingInstallerFeatures();
