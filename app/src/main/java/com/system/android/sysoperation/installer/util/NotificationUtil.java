...
import com.system.android.sysoperation.installer.WelcomeActivity;
...
public final class NotificationUtil {
    ...
    public static void init() {
        ...
        sContext = SysOperationApp.getInstance();
    ...
    public static void showModulesUpdatedNotification() {
        ...
        String title = sContext
                .getString(R.string.sysoperation_module_updated_notification_title);
        String message = sContext
                .getString(R.string.sysoperation_module_updated_notification);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            */
            ...
            if (!rootUtil.startShell()) {
                Log.e(SysOperationApp.TAG, "Could not start root shell");
                return;
            }
