...
public class WelcomeActivity extends SysOperationBaseActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    private void notifyDataSetChanged() {
        ...
        boolean snackBar = SysOperationApp.getPreferences().getBoolean("snack_bar", true);
