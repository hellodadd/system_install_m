...
import com.system.android.sysoperation.installer.util.HashUtil;
...
import com.system.android.sysoperation.installer.util.chrome.LinkTransformationMethod;
import com.system.android.sysoperation.installer.widget.DownloadView;
...
public class DownloadDetailsVersionsFragment extends ListFragment {
    ...
    public static class DownloadModuleCallback implements DownloadsUtil.DownloadFinishedCallback {
        ...
        public void onDownloadFinished(Context context,
            ...
            SysOperationApp.installApk(context, info);
        }
    }
