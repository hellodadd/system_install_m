package com.system.android.sysoperation.installer.installation;
...
import com.system.android.sysoperation.installer.util.DownloadsUtil.DownloadFinishedCallback;
import com.system.android.sysoperation.installer.util.DownloadsUtil.DownloadInfo;
import com.system.android.sysoperation.installer.util.FrameworkZips;
import com.system.android.sysoperation.installer.util.FrameworkZips.FrameworkZip;
import com.system.android.sysoperation.installer.util.FrameworkZips.LocalFrameworkZip;
import com.system.android.sysoperation.installer.util.FrameworkZips.LocalZipLoader;
import com.system.android.sysoperation.installer.util.FrameworkZips.OnlineFrameworkZip;
import com.system.android.sysoperation.installer.util.FrameworkZips.OnlineZipLoader;
import com.system.android.sysoperation.installer.util.InstallZipUtil;
import com.system.android.sysoperation.installer.util.Loader;
import com.system.android.sysoperation.installer.util.NavUtil;
import com.system.android.sysoperation.installer.util.RootUtil;
import com.system.android.sysoperation.installer.util.RunnableWithParam;

public class StatusInstallerFragment extends Fragment {
    public static final File DISABLE_FILE = new File(SysOperationApp.BASE_DIR + "conf/disabled");
        ...
        disableSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (DISABLE_FILE.exists()) {
                    DISABLE_FILE.delete();
                    Snackbar.make(disableSwitch, R.string.sysoperation_on_next_reboot, Snackbar.LENGTH_LONG).show();
                } else {
                    try {
                        DISABLE_FILE.createNewFile();
                        Snackbar.make(disableSwitch, R.string.sysoperation_off_next_reboot, Snackbar.LENGTH_LONG).show();
                    } catch (IOException e) {
                        Log.e(SysOperationApp.TAG, "Could not create " + DISABLE_FILE, e);
                    }
                }
            }
        });
                    ...
                    .onPositive(new MaterialDialog.SingleButtonCallback() {
                        ...
                        public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                            if (dialog.isPromptCheckBoxChecked()) {
                                SysOperationApp.getPreferences().edit().putBoolean("hide_install_warning", true).apply();
                            }
                        }
                    })
    ...
    private void refreshInstallStatus() {
        ...
        int active = SysOperationApp.getActiveSysOperationVersion();
        int installed = SysOperationApp.getInstalledSysOperationVersion();
        Log.i("zwb", " active = " + active + ", installed = " + installed);
        if (installed < 0) {
            ...
            txtInstallError.setText(getString(R.string.framework_not_active, SysOperationApp.getSysOperationProp().getVersion()));
            ...
            txtInstallError.setText(getString(R.string.framework_active, SysOperationApp.getSysOperationProp().getVersion()));
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mShowOutdated = SysOperationApp.getPreferences().getBoolean("framework_download_show_outdated", false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.show_outdated:
                ...
                SysOperationApp.getPreferences().edit().putBoolean("framework_download_show_outdated", mShowOutdated).apply();
    ...
    private File getCanonicalFile(File file) {
        try {
            ...
            Log.e(SysOperationApp.TAG, "Failed to get canonical file for " + file.getAbsolutePath(), e);
            return file;
        }
    }
    ...
    private void refreshKnownIssue(View v) {
        ...
        final File baseDir = new File(SysOperationApp.BASE_DIR);
        ...
        final InstallZipUtil.SysOperationProp prop = SysOperationApp.getSysOperationProp();
        ...
        if (missingFeatures != null && !missingFeatures.isEmpty()) {
            ...
            Log.e(SysOperationApp.TAG, "Base directory: " + getPathWithCanonicalPath(baseDir, baseDirCanonical));
            Log.e(SysOperationApp.TAG, "Expected: " + getPathWithCanonicalPath(baseDirActual, baseDirActualCanonical));
            ...
            issueLink = "https://github.com/rovo89/SysOperationInstaller/issues/395";
        } else if (!baseDir.exists()) {
            issueName = getString(R.string.known_issue_missing_base_directory);
            issueLink = "https://github.com/rovo89/SysOperationInstaller/issues/393";
        } else {
            issueName = null;
            issueLink = null;
        }
    ...
    private void determineVerifiedBootState(View v) {
        try {
            ...
            Log.e(SysOperationApp.TAG, "Could not detect Verified Boot state", e);
        }
    }
